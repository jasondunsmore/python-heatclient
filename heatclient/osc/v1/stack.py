...
class UpdateStack(show.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.dry_run is True:
            resource_changes = client.stacks.preview_update(**fields)

            formatters = {
                'resource_identity': heat_utils.json_formatter
            }
        ...
        return _show_stack(client, parsed_args.id, format='table', short=True)
